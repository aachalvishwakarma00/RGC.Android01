    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'assets/images/cool.png', 'Aquaman'),
            _buildHero(context, 'assets/images/green.jpg', 'Superman'),
            _buildHero(context, 'assets/images/nature.jpg', 'Wonderwomen'),
          ],
        ),
      ),
    );
